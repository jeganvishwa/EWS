...
$(document).ready(function() {
    setTimeout(function() {
        ...
        $(function() {
            ...
            getDayWiseTimeSeries(new Date('01 Jan 2024 GMT').getTime(), 10, {
                min: 20,
                max: 100
            })
        ...
        $(function() {
            var options = {
                ...
                series: [{
                        name: "Closed",
                        data: [45, 52, 38, 24, 33, 26, 21, 20, 6, 8, 15, 10, 12, 20, 11]
                    },
                    {
                        name: "Pending",
                        data: [35, 41, 62, 42, 13, 18, 29, 37, 36, 51, 32, 35, 4, 10, 9]
                    },
                    {
                        name: 'Total',
                        data: [87, 57, 74, 99, 75, 38, 62, 47, 82, 56, 45, 47, 16, 30, 20]
                    }
                ],
                title: {
                    text: '',
                ...
                xaxis: {
                    categories: ['Z-01', 'Z-02', 'Z-03', 'Z-04', 'Z-05', 'Z-06', 'Z-07', 'Z-08', 'Z-09',
        ...
        $(function() {
            var closedData = [45, 52, 38, 24, 33, 26, 21, 20, 6, 8, 15, 10, 12, 20, 11];
            var openData = [20, 30, 25, 50, 40, 15, 10, 5, 20, 15, 20, 25, 30, 40, 35];
            var totalData = closedData.map((closed, index) => closed + openData[index]);
